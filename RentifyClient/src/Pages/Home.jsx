    ...
    return (
        <div className="w-full overflow-hidden bg-[url('./Assets/Home.jpg')] bg-cover bg-center h-[84vh] md:h-screen">
            <div className="relative flex justify-center items-center md:h-[500px] md:mt-28">
                <div className="w-96 mt-12 bg-[rgba(0,0,0,0.7)] text-center p-3 rounded-lg md:w-[900px]">
                ...
                <div className="flex justify-center mt-4">
                    <button className='text-sm md:text-base p-2.5 text-white md:w-1/5 bg-blue-600 rounded-md hover:bg-red-600'
