...
function About() {
  return (
    <div className='py-20 px-4 max-w-screen-2xl  mx-auto min-h-screen'>
      <h1 className='font-nunito text-3xl md:text-5xl font-bold mb-4 text-slate-800'>About Rentify</h1>
      <p className='mb-4 text-slate-700'>
        Rentify is your go-to platform for finding, renting, and managing properties with ease. 
      ...
      <p className='mb-4 text-slate-700'>
        Whether you are a tenant looking for your next home or a landlord searching for reliable tenants, Rentify is here to help. 
      ...
      <p className='mb-4 text-slate-700'>
        ...
        At Rentify, we value trust, transparency, and innovation.
      </p>
      <p className='mb-4 text-slate-700'>
        Join us at Rentify and discover a new way of renting properties that is simple, efficient, and hassle-free. 
        We are excited to be a part of your rental journey and look forward to helping you find your perfect home.
      </p>

      {/* Why Choose Us Section */}
      <div className="bg-white p-4 rounded-lg">
        <h1 className="font-nunito font-bold text-center text-3xl md:text-5xl"> Why Choose Rentify </h1>
