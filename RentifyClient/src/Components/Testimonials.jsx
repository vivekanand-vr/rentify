...
const Testimonials = () => {
  return (
    <div className="w-full max-w-4xl mx-auto bg-white text-center p-6 mt-6 rounded-lg md:p-8">
      ...
      >
        {testimonialsData.map((testimonial, index) => (
          <SwiperSlide key={index}>
            <div className="flex flex-col items-center p-3 bg-slate-300 bg-opacity-70 md:h-64 rounded-lg shadow-lg border-neutral-300">
